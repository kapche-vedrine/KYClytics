...
export async function registerRoutes(
  ...
  app.get("/api/clients/:id/report", authMiddleware, async (req, res) => {
    try {
      ...
      doc.fontSize(8).fillColor(grayColor).text('This report is generated by KYClytics for compliance purposes only.', 50, footerY, { align: 'center', width: doc.page.width - 100 });
      doc.fontSize(8).text(`© ${new Date().getFullYear()} KYClytics. All rights reserved.`, 50, footerY + 12, { align: 'center', width: doc.page.width - 100 });
